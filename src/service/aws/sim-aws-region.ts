...
interface SimAwsRegionProperties {
...
export class SimAwsRegion {
  ...
  constructor(properties: SimAwsRegionProperties = {}) {
  ...
  /**
   * Get simulated Lambda for this Region's default Account.
   */
  lambda(): SimLambda {
    return this.account().lambda();
  }
