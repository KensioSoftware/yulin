...
import { SimHttpApiOpenApiObject } from "./sim-http-api-openapi-object.js";
...
interface SimHttpApiOpenApiValueProperties {
 ...
 */
export class SimHttpApiOpenApiValue {
  public readonly pointer: SimHttpApiOpenApiPointer;
  private readonly value: JSONValue | undefined;

  constructor(properties: SimHttpApiOpenApiValueProperties) {
   ...
   */
  object(): SimHttpApiOpenApiObject {
   ...
   */
  optionalObject(): SimHttpApiOpenApiObject | undefined {
    ...
    return new SimHttpApiOpenApiObject({
